...
const BannerFist = (props) => {
  ...
  return (
    <Box py={3}>
      {/* <Box className={classNames(classes.container_banner_fist, 'reveal')}>
        {Array(3)
          .fill(1)
          .map((item) => {
            return (
      ...
      <Box className={classNames(classes.container_banner_fist_2, 'reveal')}>
        {Array(2)
          .fill(1)
          .map((item) => {
            return (
