...
const UtilSaleWith = (props) => {
  ...
  return (
    <>
      <Box className={classes.bx_container_sw}>
        <Box className={classes.bx_curcle}>
          <Typography
            variant="h3"
        ...
        <Box
          onClick={() => handleOpen()}
          className={classNames(classes.bx_curcle_mask, 'bx_curcle_mask')}
        ></Box>
      </Box>
      <Modal
        open={open}
